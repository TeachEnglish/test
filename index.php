...
<body class="dark">
    ...
    <script>
        ...
        const config = {
            dataUrl: buildUrl + "/d1700b3949a95e4716126b7b2d1f7945.data.unityweb",
            frameworkUrl: buildUrl + "/116caf324e3135f4afea0ee368da88f9.js.unityweb",
            codeUrl: buildUrl + "/1304c8897f9bdbaf7048654f77e57888.wasm.unityweb",
    ...
    <div class="modal fade" id="videoModal" tabindex="-1" aria-labelledby="videoModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header" style="max-height: 1%">
    ...
    let videoElement = document.getElementById("videoPlayer");
    // 強制關閉 Modal
    let modal = new bootstrap.Modal(videoModal);
    modal.hide();
    ...
    console.log("Modal 已強制關閉");
    //videoElement.pause();
    //videoElement.src = ""; // 清空影片來源
    console.log("影片已強制停止");
}
